...
const job = {
  ...
  location: "Remote (US)",
  type: "Full Time",
  description: "We are seeking a Senior UX Designer to lead the design of our digital products. You will work closely with product managers and engineers to create intuitive, user-centric designs that solve real-world problems for our clients. Our mission is to empower businesses of all sizes to thrive in an ever-changing marketplace.",
  responsibilities: [
    "Lead the UX design process from research to final delivery.",
    "Conduct user research and usability testing to validate designs.",
    "Create wireframes, prototypes, and high-fidelity mockups.",
    "Collaborate with cross-functional teams to align design with business goals."
  ],
  requirements: [
    "6+ years of experience in UX/UI Design.",
    "Proficiency in Figma, Sketch, and Adobe Creative Suite.",
    "Strong portfolio showcasing complex, high-impact projects."
  ]
};

export default function SeniorUXPage() {
