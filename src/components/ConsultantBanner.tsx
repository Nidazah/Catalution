...
export default function ConsultantBanner() {
  return (
    <section className="w-full bg-navy py-12 md:py-14 overflow-hidden relative">
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-12">
          ...
          <Button
            href="/contact"
            size="md"
            className="bg-white !text-navy [&_svg]:!text-white transition-transform hover:scale-105"
          >
            Lets talk now
          </Button>
        </div>
