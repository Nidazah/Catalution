...
const MENU_ITEMS: MenuItem[] = [
  ...
  { label: "Website CMS", href: "/admin/content", icon: FilePenLine },
  ...
  { label: "Portfolios", href: "/admin/portfolio", icon: Images },
  { label: "Blog", href: "/admin/blog", icon: Newspaper },
  { label: "Team", href: "/admin/team", icon: Users },
  { label: "Careers", href: "/admin/careers", icon: Briefcase },
  { label: "Applications for Jobs", href: "/admin/career-applications", icon: ClipboardList },
  {
    label: "Testimonials",
